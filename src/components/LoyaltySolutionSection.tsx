        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-12">
              <div className="text-center lg:text-left slide-in-mask delay-1">
              ...
              <div className="text-center lg:text-left slide-in-mask delay-2">
                <div className="inline-flex items-center justify-center w-12 h-12 bg-teal text-white rounded-lg mb-4">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-center lg:text-left slide-in-mask delay-3">
                <div className="inline-flex items-center justify-center w-12 h-12 bg-teal text-white rounded-lg mb-4">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-center lg:text-left slide-in-mask delay-4">
                <div className="inline-flex items-center justify-center w-12 h-12 bg-teal text-white rounded-lg mb-4">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
